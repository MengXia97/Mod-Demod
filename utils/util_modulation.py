...
def get_mqam_symbol(k, M, gray_code):  # M must be a square number
    ...
    if k < M:
        ...
        scaling_factor = (1 / (
            np.sqrt((2.0 / 3) * (M - 1))))  # scaling factor so overall constellation has unit average energy
...
# For QPSK
# symbol_maps[2] = np.array([[0.7071067811865476, 0.7071067811865475], [-0.7071067811865475, 0.7071067811865476],
#                            [0.7071067811865474, -0.7071067811865477], [-0.7071067811865477, -0.7071067811865475]])

symbol_maps[2] = np.array([[1, 0], [0, 1],
                           [0, -1], [-1, 0]])
# For 8PSK
symbol_maps[3] = np.array([[0.9238795325112867, 0.3826834323650898], [0.38268343236508984, 0.9238795325112867],
                           [-0.9238795325112867, 0.3826834323650899], [-0.3826834323650897, 0.9238795325112867],
                           [0.9238795325112865, -0.3826834323650904], [0.38268343236509, -0.9238795325112866],
                           [-0.9238795325112868, -0.38268343236508967], [-0.38268343236509034, -0.9238795325112865]])
# For 16QAM
symbol_maps[4] = np.array([[-0.9486832980505138, -0.9486832980505138], [-0.9486832980505138, -0.31622776601683794],
                           ...
                           [0.31622776601683794, 0.9486832980505138], [0.31622776601683794, 0.31622776601683794]])
# For 64QAM
symbol_maps[6] = np.array([[-1.0801234497346435, -1.0801234497346435], [-1.0801234497346435, -0.7715167498104596],
